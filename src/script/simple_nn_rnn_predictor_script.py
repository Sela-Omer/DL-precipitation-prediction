...
from src.module.simple_nn_rnn_predictor import SimpleNN_RNNPredictor
...
class SimpleNN_RNNPredictorScript(SimpleNNScript, ABC):
    """
    ...
    def create_architecture(self, datamodule: pl.LightningDataModule):
        ...
        model = SimpleNN_RNNPredictor(self.service, example_input_array=example_input_array, **model_hyperparams)
