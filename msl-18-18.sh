...
OVERWRITE_CONFIG_PATH="src/config/cnn_skip_connection/config-v5-intensity-1979-2024-lookback3h-forecast1h-circular-norm-cnn-skip-empty_norm-max_pool-depth_8.ini"
MODE="DATA_ANALYSIS,FIT,EVAL,EVAL_STORM_CLASSIFICATION"
